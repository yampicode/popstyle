        ...
        function submitForm(event) {
            ...
            const text = `Hola, me gustaría reservar una cita:%0A%0A*Nombre:* ${name}%0A*Teléfono:* ${phone}%0A*Email:* ${email}%0A*Servicio:* ${service}%0A*Fecha preferida:* ${date}%0A*Mensaje:* ${message}`;
